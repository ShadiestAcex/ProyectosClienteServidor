<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Directivos.aspx.cs" Inherits="ProyectoAct9CS.Crud.Directivos" %>
...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            <asp:GridView ID="GV_directivos" runat="server" AutoGenerateColumns="False" DataSourceID="NewSqlDataSourceDirectivosEdoMunLoc" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnSelectedIndexChanged="GV_directivos_SelectedIndexChanged">
                <Columns>
            ...
            <asp:SqlDataSource runat="server" ID="NewSqlDataSourceDirectivosEdoMunLoc" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="SELECT Nomina, Nombre, APaterno, AMaterno, RFC, CURP, Sexo, estado, municipio, localidad, latitud, longitud FROM NewDirectivosEdoMunLoc"></asp:SqlDataSource>
