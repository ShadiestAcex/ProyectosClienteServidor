<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Alumnos.aspx.cs" Inherits="ProyectoAct9CS.Crud.Alumnos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <asp:GridView ID="GV_alumnos" runat="server" AutoGenerateColumns="False" DataSourceID="NewSqlDataSourceAluEdoMunLoc" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GV_alumnos_SelectedIndexChanged">
                ...
                <asp:SqlDataSource runat="server" ID="NewSqlDataSourceAluEdoMunLoc" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="SELECT Matricula, Nombre, APaterno, AMaterno, RFC, CURP, Sexo, estado, municipio, localidad, latitud, longitud FROM NewAlumnosEdoMunLoc"></asp:SqlDataSource>
