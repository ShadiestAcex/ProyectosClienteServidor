<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="ProyectoConsWSVB.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="ProyectoConsWSVB" %>
