<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="Act2_VB.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="Act2_VB" %>
