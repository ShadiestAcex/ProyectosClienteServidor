<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="ProyectoCrudWSVB.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="ProyectoCrudWSVB" %>
