<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="ProyectoActividad6VB.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="ProyectoActividad6VB" %>
