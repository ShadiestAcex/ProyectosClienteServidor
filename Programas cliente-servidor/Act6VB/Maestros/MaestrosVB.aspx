<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaestrosVB.aspx.vb" Inherits="ProyectoActividad6VB.MaestrosVB" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <asp:GridView ID="GV_maestros" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceMaestrosEdoMunLoc" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" OnSelectedIndexChanged="GV_maestros_SelectedIndexChanged">
